...
(function() {
    ...
    var DEBUG_PRINT_INTERVAL_MS = 1000;
    ...
    PrivacyButton.prototype = {
        ...
        transition: function() {
            ...
            if (debuggingPrintInterval) {
                Script.clearInterval(debuggingPrintInterval);
                debuggingPrintInterval = null;
            }
            ...
            debuggingPrintInterval = Script.setInterval(function() {
                print("DOOR ID: ", door, " FROM CHATTERBOX ", chatterbox, " IS AT WORLD POSITION: ", 
                    JSON.stringify(Entities.getEntityProperties(door, 'position').position));
